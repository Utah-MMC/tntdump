           ...
           <div className="space-y-4">
            ...
            <div className="space-y-2">
                ...
                <Phone className="h-4 w-4 text-green-500" />
                               <a href="tel:+18012099013" className="text-yellow-300 hover:text-yellow-100">
                 (801) 209-9013
               </a>
               </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-green-500" />
                <a href="mailto:sales@tntdump.com" className="text-yellow-300 hover:text-yellow-100">
                  sales@tntdump.com
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="h-4 w-4 text-green-500" />
                <span className="text-gray-100">Wasatch Front, UT</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6">
               {navigation.legal.map((item) => (
                 <Link
                   key={item.name}
                   href={item.href}
                  className="text-yellow-300 hover:text-yellow-100 text-xs sm:text-sm transition-colors"
                 >
                   {item.name}
                 </Link>
               ))}
