...
export default function CityPageTemplate({ city, state }: CityPageTemplateProps) {
  ...
  return (
    <main className="min-h-screen">
      ...
      />
      {/* SEO SWEEP START [/city-intro] */}
      <section className="py-6 bg-white">
        <div className="container-custom max-w-4xl">
          <p className="text-sm text-gray-700">
            Need a local dumpster rental in {city}? We deliver roll off dumpsters with careful placement and clear scheduling. For pricing basics see <a href="/#pricing" className="text-blue-600 hover:underline">dumpster rental cost</a>, and check <a href="/#same-day" className="text-blue-600 hover:underline">same day dumpster rental</a> availability. Serving Salt Lake & Utah County and nearby communities.
          </p>
        </div>
      </section>
      {/* SEO SWEEP END [/city-intro] */}
      ...
      {/* SEO SWEEP START [/city-service-schema] */}
      <script
      ...
      />
      {/* SEO SWEEP END [/city-service-schema] */}
