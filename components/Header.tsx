                ...
                <div className="text-yellow-400">
                  ...
                  <div className="flex items-center space-x-1">
                    <span className="text-sm">Call or Text</span>
                                         <a href="tel:+18012099013" className="text-lg font-bold text-yellow-600 hover:text-yellow-700 transition-colors">
                       (801) 209-9013
                     </a>
                  </div>
                </div>
              ...
              <nav className="hidden lg:flex items-center space-x-8">
               {navigation.map((item) => (
                 <div key={item.name} className="relative">
                                       <Link
                      href={item.href}
                      className={`flex items-center space-x-1 text-yellow-600 hover:text-yellow-700 font-medium transition-colors ${item.name === 'Home' ? 'underline' : ''}`}
                      onMouseEnter={() => {
                        if (item.hasDropdown) {
               ...
               <nav className="space-y-2">
                 {navigation.map((item) => (
                   <Link
                     key={item.name}
                     href={item.href}
                     className="block py-3 px-4 text-yellow-600 hover:text-yellow-700 font-medium hover:bg-primary-600/50 rounded-lg transition-colors"
                   ...
                   <div className="px-4">
                     ...
                     <a href="tel:+18012099013" className="text-lg font-bold text-yellow-600 hover:text-yellow-700 block">
                       (801) 209-9013
                     </a>
                   </div>
                 </div>
