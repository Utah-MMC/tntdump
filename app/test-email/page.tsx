      ...
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="mb-8">
          ...
          <div className="bg-gray-100 p-4 rounded-lg">
            <ul className="space-y-2">
              ...
              <li><strong>To:</strong> icondumpsters@gmail.com</li>
              <li><strong>CC:</strong> None (direct delivery)</li>
        ...
        {result && (
          <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <p className="text-green-600 text-sm mt-2">
              Check your email at icondumpsters@gmail.com for the test email!
            </p>
          </div>
        )}
        ...
        <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <ul className="text-blue-700 text-sm space-y-1">
            <li>• Sends a test email from admin@tntdump.com to icondumpsters@gmail.com</li>
            <li>• Direct delivery (no CC) to ensure emails reach the right inbox</li>
