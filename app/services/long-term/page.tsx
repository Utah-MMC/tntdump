...
export default function LongTermServicePage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* SEO SWEEP START [/services/long-term-faq] */}
      <section className="section-padding bg-white">
        <div className="container-custom max-w-3xl">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Long-Term Dumpster FAQs</h2>
          <div className="space-y-3 text-sm">
            ...
            <details className="border rounded p-4 bg-gray-50">
              ...
              <div className="mt-2">We tailor size, tonnage, and frequency. See <a href="/#pricing" className="text-blue-600 hover:underline">dumpster rental cost</a>.</div>
            </details>
            <details className="border rounded p-4 bg-gray-50">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          mainEntity: [
            { '@type': 'Question', name: 'Do you offer scheduled pickups?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, recurring pickups and swaps are available based on your operation.' } },
            { '@type': 'Question', name: 'How is pricing structured?', acceptedAnswer: { '@type': 'Answer', text: 'We tailor size, tonnage, and frequency. See the homepage pricing section.' } },
            { '@type': 'Question', name: 'Can you handle multi-site accounts?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, we can manage multi-site accounts with one point of contact.' } }
          ]
        }) }}
      />
      {/* SEO SWEEP END [/services/long-term-faq] */}
