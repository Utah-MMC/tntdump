...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Dumpster Size Calculator | Find the Right Size | T&T Dumpsters',
    description: 'Use our free dumpster size calculator to find the perfect dumpster for your project. Get instant recommendations, pricing, and free quotes.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'T&T Dumpsters - Free dumpster size calculator',
      },
    ],
    locale: 'en_US',
    type: 'website',
