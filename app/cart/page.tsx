            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 mt-8">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <p className="text-gray-700">
                  Give us a call at{' '}
                  <a href="tel:801-209-9013" className="text-blue-600 hover:text-blue-700 font-semibold underline">
                    (801) 209-9013
                  </a>{' '}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-4">
              ...
              <p className="text-gray-700 mb-4">
                Unlock contractor pricing, powered by TNT Dump, for multi-project or ongoing rentals.
              </p>
              <a 
                href="/contact" 
                className="block text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors mb-4"
              >
                Contact Us
              </a>
              <a 
      ...
      <div className="bg-gray-100 py-6 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-sm text-gray-600 text-center">
            TNT Dump assists individuals, commercial and industrial customers by assessing their disposal needs and facilitating 
