...
export const metadata: Metadata = {
  title: 'Concrete Dumpsters | TNT Dump',
  description:
  ...
  alternates: {
    canonical: 'https://tntdump.com/dumpsters/concrete',
  },
}
...
export default function ConcreteDumpstersPage() {
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600">
                Specialized dumpsters designed for heavy materials like concrete, brick, and asphalt. Perfect for construction and demolition projects requiring robust waste management solutions.
              </p>
              {/* SEO SWEEP START [/dumpsters/concrete] */}
              <p className="text-sm text-gray-700">
                For pricing basics, see <a href="/#pricing" className="text-blue-600 hover:underline">dumpster rental cost</a>. We support <a href="/#contractors" className="text-blue-600 hover:underline">construction dumpster rental</a> with swaps and clear loading guidance. Serving Salt Lake & Utah County.
              </p>
              {/* SEO SWEEP END [/dumpsters/concrete] */}
      ...
      {/* SEO SWEEP START [/dumpsters/concrete-schema] */}
      <script
      ...
      />
      {/* SEO SWEEP END [/dumpsters/concrete-schema] */}
