...
export default function VendorDumpsters() {
  const sizes = [
    {
      size: '15 Yard',
      description: 'Ideal for vendor cleanups and small job sites',
    ...
    {
      size: '20 Yard',
      description: 'Great for vendor renovations and medium projects',
    ...
    {
      size: '30 Yard',
      description: 'Perfect for larger vendor projects',
