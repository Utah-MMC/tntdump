...
export const metadata: Metadata = {
  ...
  description: 'Dumpster size guide: dimensions, capacity, and best uses. Estimate volume, avoid overages, plan placement, and compare pricing.',
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              ...
              <p>Now, sizes aren't just about volume. Dimensions matter because your site has limits. A 10 yard dumpster is usually around 12 ft long × 7–8 ft wide × 3.5 ft high. It’s short and squat—great for tight driveways, small cleanouts, and heavy debris like tile or concrete (with weight restrictions, of course). A 15 yard dumpster bumps the height a bit (about 4–4.5 ft high), keeping a compact footprint. The 20 yard dumpster is the crowd favorite: commonly about 17 ft long × 7.5 ft wide × 5 ft high. It fits most residential driveways and handles moderate renovation debris—drywall, cabinets, flooring, roofing shingles.</p>
              <p>When you step up to a 30 yard dumpster (~18.3 ft × 7.3 ft × 6.6 ft), you’re in renovation territory: multi-room projects, basement cleanouts, light construction debris. For bulky, lighter material like demoed framing lumber, large furniture, cardboard, and packaging, plan capacity carefully and consider scheduling a swap-out if you need more space. If you’re tossing dense stuff (think brick, dirt, concrete), don’t assume bigger is better. You’ll hit dumpster weight limits before you run out of space. That’s when smaller, “heavy debris” boxes or clean concrete containers make sense.</p>
              ...
              <p>New construction framing cleanup or multi-room renovation? 30 yard is the workhorse. Huge renos or commercial cleanouts with lots of packaging and drywall? A 30 yard with a planned swap-out can be perfect—especially if material isn’t dense. Remember: when in doubt between two sizes, I go up. It’s usually cheaper than a second haul triggered by overage and less disruptive.</p>
              ...
              <p>Bottom line: size your dumpster by both volume and weight. If your debris is heavy debris, do not chase the largest size just for space. Use smaller sizes, more pickups if needed, and keep an eye on the tonnage math. Your wallet will thank you.</p>
