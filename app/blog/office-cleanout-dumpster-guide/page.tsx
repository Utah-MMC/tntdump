...
import { Calendar, User, Clock, ArrowLeft, Building2, CheckCircle } from 'lucide-react'
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="relative h-96 rounded-lg overflow-hidden">
              <Image src="/images/dumpster2-500x500-2.jpeg" alt="Office cleanout dumpster rental guide" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
