        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              ...
              <p>Front-load dumpsters (2, 3, 4, 6, 8 yard) are your steady, subscription-style containers for municipal solid waste (MSW) and recycling. They’re compact, live in enclosures, and get picked on set route days. Roll-off containers (10, 20, 30, 40 yard) are the big cousins used for projects, C&amp;D debris, or bulky cleanouts.</p>
