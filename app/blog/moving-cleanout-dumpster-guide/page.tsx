...
import { Calendar, User, Clock, ArrowLeft, Truck, CheckCircle } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to dumpster rental for moving cleanouts. Learn which size you need, what items fit, cost estimates, timeline planning, and tips for efficient moving cleanout in Utah.',
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="relative h-96 rounded-lg overflow-hidden">
              <Image src="/images/dumpster2-500x500-2.jpeg" alt="Moving cleanout dumpster rental guide" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
