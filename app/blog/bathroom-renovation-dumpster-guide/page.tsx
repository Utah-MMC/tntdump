...
export const metadata: Metadata = {
  ...
  description: 'Complete bathroom renovation dumpster guide covering optimal sizes (10-15 yards), what gets removed, weight considerations for tile and fixtures, cost estimates ($300-$500), and timeline planning for bathroom remodels.',
