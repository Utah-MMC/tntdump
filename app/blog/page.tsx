...
const blogPosts = [
  ...
  },
  {
    ...
    image: '/images/20-yard-dumpster-card.jpg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-14',
    category: 'Size Guide',
    readTime: '6 min read',
  ...
  },
  {
    ...
    image: '/images/15-yard-dumpster-card.jpg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-13',
    category: 'Size Guide',
    readTime: '6 min read',
  ...
  {
    id: 13,
    title: 'Moving Out? Complete Dumpster Rental Guide for Relocations',
    excerpt: 'Moving to a new home? Learn which dumpster size you need, what to discard vs move, cost-effective strategies, and timeline coordination for relocations.',
    image: '/images/dumpster-rental-driveway.jpeg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-25',
    category: 'Project Planning',
    readTime: '5 min read',
    slug: 'moving-out-dumpster-guide'
  },
  {
    id: 14,
    title: 'Concrete Disposal: Dumpster Guide & Weight Limits 2025',
    excerpt: 'Complete guide to concrete disposal including weight calculations, clean vs mixed loads, sizing recommendations, and cost-effective disposal strategies.',
    image: '/images/demolition-167738_1280.jpg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-24',
    category: 'Waste Management',
    readTime: '6 min read',
    slug: 'concrete-disposal-dumpster-guide'
  },
  {
    id: 15,
    title: 'Garage Cleanout Dumpster Size Guide: What You Need to Know',
    excerpt: 'Planning a garage cleanout? Learn which dumpster size for one or two-car garages, what items to watch for, hazmat warnings, and cost estimates.',
    image: '/images/dumpsterSmallBanner.jpeg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-23',
    category: 'Project Planning',
    readTime: '5 min read',
    slug: 'garage-cleanout-dumpster-guide'
  },
  {
    id: 16,
    title: 'Basement Cleanout: How to Choose the Right Dumpster Size',
    excerpt: 'Complete basement cleanout guide with sizing recommendations, common items, access considerations, sorting strategies, and cost estimates.',
    image: '/images/dumpsterSmallBanner2.jpeg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-22',
    category: 'Project Planning',
    readTime: '5 min read',
    slug: 'basement-cleanout-dumpster-guide'
  },
  {
    id: 17,
    title: 'Roofing Project Dumpster Guide: Sizing for Shingle Disposal',
    excerpt: 'Expert guide to roofing dumpsters including size by roof squares, shingle weight calculations, multi-layer considerations, and cost estimates.',
    image: '/images/roof-truss-3339206_1280.jpg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-21',
    category: 'Project Planning',
    readTime: '6 min read',
    slug: 'roofing-project-dumpster-guide'
  },
  {
    id: 18,
    title: 'Bathroom Renovation Dumpster: Size & Cost Guide 2025',
    excerpt: 'Planning a bathroom remodel? Learn which dumpster size you need, what debris to expect, weight considerations, and accurate cost estimates.',
    image: '/images/pexels-jplenio-2566826.jpg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-20',
    category: 'Project Planning',
    readTime: '5 min read',
    slug: 'bathroom-renovation-dumpster-guide'
  },
  {
    id: 19,
    title: 'What Size Dumpster Do I Need? Complete Selection Guide 2025',
    excerpt: 'Comprehensive guide to choosing the right dumpster size for any project. Includes decision tree, 20+ project recommendations, and volume calculations.',
  ...
  },
  {
    ...
    excerpt: 'Detailed comparison of 20 and 30-yard dumpsters including capacity, cost differences, weight considerations, and when to choose each size.',
  ...
  {
    id: 21,
    title: '15 Yard vs 20 Yard Dumpster: Which Size Do You Need?',
    excerpt: 'Side-by-side comparison of 15 and 20-yard dumpsters. Learn capacity differences, cost analysis, and ROI to choose the right size for your project.',
  ...
  {
    id: 22,
    title: '30 Yard Dumpster: When to Use & What Fits | Complete Guide',
    excerpt: 'Complete guide to 30-yard dumpsters including dimensions, capacity, weight limits, best projects, and critical weight warnings for large renovations.',
    image: '/images/30-yard-dumpster-card.jpg',
    author: 'TNT Dumpsters Team',
    date: '2025-01-16',
    category: 'Size Guide',
    readTime: '6 min read',
